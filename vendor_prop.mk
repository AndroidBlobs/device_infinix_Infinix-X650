PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    persist.dirac.acs.usecase_order=powersound \
    ...
    ro.com.google.clientidbase.ms=android-transsion-infinix-rev1 \
    ...
    ro.config.notification_sound=Infinix_XUI_SMS.ogg \
    ro.config.ringtone=Landscape.ogg \
    ro.config.ringtone_sim2=Landscape.ogg \
    ro.contacts.isFBsupport=1 \
    ro.control_privapp_permissions=log \
    ro.cy_himgr_support=1 \
    ro.deskclock_n_to_o_support=0 \
    ro.doze_whatsapp_mode=1 \
    ...
    ro.infinix_dirac_support=1 \
    ro.jump_to_osmgr=1 \
    ro.kom_telephony_support=0 \
    ro.ksc5601_write=0 \
    ...
    ro.mediatek.version.release=X650-H8029AB-OGo-190815V214 \
    ro.mediatek.version.sdk=4 \
    ro.midtest.camera_af_support=1 \
    ro.midtest.compass_support=1 \
    ro.midtest.distance_support=1 \
    ro.midtest.dual_camera_dummy=1 \
    ro.midtest.dual_camera_support=1 \
    ro.midtest.fingerprint_support=1 \
    ro.midtest.flashforward_support=1 \
    ro.midtest.light_sensor_support=1 \
    ro.midtest.ps_cal_support=1 \
    ...
    ro.os.micro_smart=1 \
    ro.os.version.release=O-P86-190731 \
    ro.os_charging_animation_support=0 \
    ro.os_filemanager_sociable_support=1 \
    ro.os_fingerprint_dismissalarm_support=1 \
    ro.os_fingerprint_incallrecord_support=1 \
    ro.os_fingerprint_quickapp_support=1 \
    ro.os_fp_pre_unlock_support=0 \
    ro.os_hide_app=1 \
    ro.os_hide_app_by_list=1 \
    ro.os_inadvertent_support=1 \
    ro.os_incoming_flashlight_support=0 \
    ro.os_mgz_service_def_enable=1 \
    ro.os_navigationbar_gesture_support=1 \
    ro.os_product.version=xos4.1 \
    ro.os_single_hand_support=1 \
    ro.os_version_name=v4.1.0 \
    ...
    ro.proinfo.memory.trace.support.dramtest=yes \
    ro.proinfo.memory.trace.support.kene=yes \
    ...
    ro.tran.def_photo_support=true \
    ro.tran.os_gallery_support=false \
    ro.tran.remove_activity_support=true \
    ro.tran_battery_light_only=1 \
    ro.tran_dirac_headphone.support=1 \
    ro.tran_localechange_optimize=1 \
    ro.tran_oobe_screenshot=1 \
    ro.tran_operator.customized.support=1 \
    ro.tran_otg_lpo_support=1 \
    ro.tran_otg_sw_support=1 \
    ro.tran_rcs_support=1 \
    ro.tranos.type=xos \
    ro.transsion.cosoftware.support=1 \
    ro.transsion.os.name=XOS \
    ro.transsion_wakelock_screenon=1 \
    ro.uae_tra_support=1 \
    ro.ussd_ksc5601=0 \
    ro.view.dropframe=false \
    ro.xcloud_wifi_support=1 \
    ro.xoslauncher_support=1 \
